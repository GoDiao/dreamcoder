...
SESSION_NAME="dreamcoder-rewind-complex-e2e-${RUN_ID}"
ARTIFACT_DIR="$(mktemp -d "/tmp/dreamcoder-rewind-complex-e2e-${RUN_ID}-XXXX")"
...
${AB} open "${WEB_URL}"
${AB} wait 2000
${AB} eval "localStorage.setItem('dreamcoder-locale', 'en'); location.reload();"
${AB} wait 2000
