  ...
  return (
    <div className="group mb-5 flex justify-end">
      ...
      >
        ...
        {hasText && (
          <div
            className="min-w-0 max-w-full bg-[var(--color-surface-user-msg)] px-4 py-3 text-sm leading-relaxed text-[var(--color-text-primary)] whitespace-pre-wrap break-words [overflow-wrap:anywhere] [word-break:break-word] rounded-[18px] rounded-tr-[4px] rounded-br-[18px] rounded-bl-[18px]"
          >
            {content}
          </div>
        )}
